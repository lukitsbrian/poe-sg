...
import (
	...
	appparams "github.com/lukitsbrian/poe-sg/app/params"
	"github.com/lukitsbrian/poe-sg/x/poesg"
	poesgkeeper "github.com/lukitsbrian/poe-sg/x/poesg/keeper"
	poesgtypes "github.com/lukitsbrian/poe-sg/x/poesg/types"
)

var (
	// DefaultNodeHome default home directories for the application daemon
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/poesgd")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	poesgKeeper poesgkeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		authtypes.StoreKey, banktypes.StoreKey, paramstypes.StoreKey, stakingtypes.StoreKey, poesgtypes.StoreKey, 
	)
	...
	app.poesgKeeper = *poesgkeeper.NewKeeper(
        appCodec, keys[poesgtypes.StoreKey], keys[poesgtypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		poesg.NewAppModule(appCodec, app.poesgKeeper),
	)
